  ...
  return (
    <section className="relative overflow-hidden px-4 pt-16 pb-12">
      <div className="relative z-10 mx-auto max-w-screen-sm text-center">
        ...
        <h1 className="mt-3 text-[50px] font-bold leading-[1.03] tracking-tight text-slate-900 md:text-[78px] md:leading-[1.05]">
          <span className="block text-slate-900">Intelligent</span>
          <span className="block text-gradient-azure">Tech for</span>
          <span className="block text-gradient-primary">Tomorrow.</span>
        </h1>
